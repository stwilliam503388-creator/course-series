...
> 📋 **前置课程**：建议先完成 [01-概率论基础](../01-概率论与数理统计/01-prob.md)（随机变量与分布）和 [02-算法设计](../02-低复杂度算法设计/02-classic-tech.md)（DP/贪心思想）。
...
| 子课程 | 覆盖的运筹学领域 | 难度 |
|--------|----------------|------|
| [02-低复杂度算法设计](../02-低复杂度算法设计) | 算法设计范式（DP、贪心、分治）的通用方法论 | 入门~进阶 |
| [05-博弈论基础与实战](../05-博弈论基础与实战) | 博弈均衡、拍卖机制、谈判策略、合作博弈 | 入门~进阶 |
| [03-PDE物理方程求解](../03-PDE物理方程求解) | 连续优化、PDE 约束下的优化（反问题/最优控制） | 进阶 |
...
| `08-capstone.md` | 🏆 综合毕业项目：急诊科资源调度优化 | ~2,000 |
